...
const Cube = ({ number, onClick, isSelected }) => (
	<div className={`cubeWrapper${isSelected ? ' selected' : ''}`} onClick={onClick}>
...
const Game = () => {
	...
	return (
		<div className='container'>
			<button onClick={() => dispatch({ type: 'roll_dice' })}>Roll Dice</button>
